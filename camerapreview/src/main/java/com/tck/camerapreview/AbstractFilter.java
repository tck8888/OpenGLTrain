...
/**
 * <p>description:</p>
 * <p>created on: 2019/7/25 14:13</p>
 *
 * @author tck
 * @version 1.0
 */
public abstract class AbstractFilter {
    ...
    protected void initilize(Context context) {
        String vertexSharder = ShaderUtils.getRawResource(context, mVertexShaderId);
        String framentShader = ShaderUtils.getRawResource(context, mFragmentShaderId);
        mGLProgramId = ShaderUtils.createProgram(vertexSharder, framentShader);
